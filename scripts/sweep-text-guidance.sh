#!/usr/bin/env bash
# Sweep text-guidance scales for one CrossFlow checkpoint and print a summary line per run.
...
run_config text20 --sway -0.8 --steps 32 --text-guidance 2.0
run_config text25 --sway -0.8 --steps 32 --text-guidance 2.5
run_config text30 --sway -0.8 --steps 32 --text-guidance 3.0
run_config text20-spk15 --sway -0.8 --steps 32 --text-guidance 2.0 --speaker-guidance 1.5
run_config text20-steps64 --sway -0.8 --steps 64 --text-guidance 2.0
echo SWEEP-DONE
